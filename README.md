...
`fomo_activity_legs`, `fomo_leaderboard_state` и `fomo_tokens`. Команда проверяет
...
`POST /api/fomo/activity/import` и `GET /api/fomo/activity?period=30d&hours=24`
(`hours` — до 8760, то есть года).
